...
if __name__ == "__main__":
    demo = SystemDescription(
        ...
        intended_purpose="Drafts replies for human support staff; staff always review before sending.",
        ai_models=["claude-sonnet-5 (Anthropic API)"],
        architecture_summary="FastAPI service -> retrieval layer -> LLM -> human review queue.",
